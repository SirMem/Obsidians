...
![image-20210903190021029](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210903190021029.png)
...
![image-20210903193913261](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210903193913261.png)
...
本章节为 **图文节**，请点击 [这里](图文课程/2-02：使用%20vue-cli%20创建项目.md) 查看对应文档



## 2-03：升级最新的 vue 版本以支持 script setup 语法（图文）

本章节为 **图文**，[[2-03：升级最新的 vue 版本以支持 script setup 语法]]请点击 查看对应文档
...
![image-20210904185336318](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210904185336318.png)
...
1. 在 `VSCode` 中安装 `prettier` 插件（搜索 `prettier`），这个插件可以帮助我们在配置 `prettier` 的时候获得提示
   ![image-20210904195026475](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210904195026475.png)
...
4. 打开 `VSCode` 《设置面板》
   ![image-20210904200638072](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210904200638072.png)

5. 在设置中，搜索 `save` ，勾选 `Format On Save`
   ![image-20210904200738067](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210904200738067.png)
...
![image-20210904201057594](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210904201057594.png)
...
![image-20210904203051754](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210904203051754.png)
...
![image-20210904205519762](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210904205519762.png)
...
![image-20210710121456416](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210710121456416.png)
...
2. 启动 `hooks` ， 生成 `.husky` 文件夹
   ...
   ![image-20210906202034156](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210906202034156.png)
...
3. 在 `package.json` 中生成 `prepare` 指令（ **需要 npm > 7.0 版本** ）
   ...
   ![image-20210906202128323](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210906202128323.png)
...
5. 执行成功，提示
   ![image-20210710120053221](%20第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210710120053221.png)
...
7. 此时的 `.husky` 的文件结构
   ![image-20210710120228931](%20第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210710120228931.png)
...
2. 该操作会生成对应文件 `pre-commit`：
   ![image-20210906204043915](第二章：标准化大厂编程规范解决方案之ESLint%20+%20Git%20Hooks%20.assets/image-20210906204043915.png)
...
本章节为 **图文**，请点击 [这里](图文课程/2-13：关于vetur检测%20template的单一根元素的问题.md) 查看对应文档
