...
![image-20210911095711012](第四章：项目架构之搭建Layout架构%20解决方案与实现.assets/image-20210911095711012.png)
...
12. 至此查看效果为
    ![image-20210911111525589](第四章：项目架构之搭建Layout架构%20解决方案与实现.assets/image-20210911111525589.png)
...
15. 查看效果
    ![image-20210911111716595](第四章：项目架构之搭建Layout架构%20解决方案与实现.assets/image-20210911111716595.png)
...
![image-20210911112904783](第四章：项目架构之搭建Layout架构%20解决方案与实现.assets/image-20210911112904783.png)
...
![image-20210911144540729](第四章：项目架构之搭建Layout架构%20解决方案与实现.assets/image-20210911144540729.png)

如遇到此错误，可 **手动到控制到 `Application` 中，删除 `LocalStorage` 中的 `token`**

![image-20210911144726082](第四章：项目架构之搭建Layout架构%20解决方案与实现.assets/image-20210911144726082.png)

删除后，重新刷新页面，重新进行登录操作（该问题如何解决，会在后续进行讲解）

至此，即可获取用户信息数据

![image-20210911144958117](第四章：项目架构之搭建Layout架构%20解决方案与实现.assets/image-20210911144958117.png)
...
![image-20210913150402667](第四章：项目架构之搭建Layout架构%20解决方案与实现.assets/image-20210913150402667.png)
...
1. 我们创建的页面并没有全部进行展示
   ...
   1. 根据该方案
      ![image-20210913151331012](第四章：项目架构之搭建Layout架构%20解决方案与实现.assets/image-20210913151331012.png)
