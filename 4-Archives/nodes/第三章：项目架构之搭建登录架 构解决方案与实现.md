...
![](第三章：项目架构之搭建登录架%20构解决方案与实现.assets/options%20api.gif)
...
![image-20210907203504116](第三章：项目架构之搭建登录架%20构解决方案与实现.assets/image-20210907203504116.png)
...
![img](第三章：项目架构之搭建登录架%20构解决方案与实现.assets/1570466251996_04-logical-concerns.jpg)
...
2. `script setup`
   ![image-20210908104702818](第三章：项目架构之搭建登录架%20构解决方案与实现.assets/image-20210908104702818.png)
...
本章节为 **图文节**，请点击 [这里](图文课程/3-06：导入%20element-plus.md) 查看对应文档
...
4. 如果期望全局导入，那么可以通过以下代码进行：
   ...
   效果：
   ![//img.mukewang.com/szimg/61a5c78609e1d47205980238.jpg](第三章：项目架构之搭建登录架%20构解决方案与实现.assets/61a5c786090e23c805000199.jpg)

## 3-07：构建登录页面 UI 结构

1. 在 `views` 中 `login` 文件夹，创建 `index.vue` 文件
   ![image-20210908112617459](第三章：项目架构之搭建登录架%20构解决方案与实现.assets/image-20210908112617459.png)
...
![image-20210910172203852](第三章：项目架构之搭建登录架%20构解决方案与实现.assets/image-20210910172203852.png)
...
![image-20210910172808352](第三章：项目架构之搭建登录架%20构解决方案与实现.assets/image-20210910172808352.png)

![image-20210910172827207](第三章：项目架构之搭建登录架%20构解决方案与实现.assets/image-20210910172827207.png)
